...
<aside
	class="fixed bottom-0 left-0 top-0 z-20 mt-10 w-56 border-r border-blue-500/60 bg-zinc-950/95 capitalize text-white"
>
	<h1 class="border-y border-blue-500/60 py-5 text-center text-2xl">Configurações</h1>
